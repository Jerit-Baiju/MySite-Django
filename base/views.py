...
def about(request):
    ...
    history = [
        ...
        "2021 - Switched to Linux. Learned Flask, CSS, JavaScript. I published my website on PythonAnywhere (currently not available). Learned more about GIT, REACT and some DS. Made many projects like ChatBot named Clara (WEB), Weather app (CLI)",
